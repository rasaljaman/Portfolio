      ...
      <div className={`relative z-10 text-center px-6 md:px-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6">
          ...
          <a
            ...
            className="group relative bg-paper border-2 border-ink/30 text-ink px-8 py-3 font-hand text-xl font-semibold rounded-lg shadow-paper hover:shadow-sticky hover:border-ink/60 transition-all duration-300 hover:-translate-y-1 flex items-center gap-2"
          >
